...
import { getColorName, getColorClass, createColorImageMap, getImageForColor } from '@/lib/colorUtils';
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="pb-8">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {product.sizes && product.sizes.map((size) => (
                                        <button
                                            key={size}
                                            className={`px-4 py-2 border text-sm rounded-md ${selectedSize === size
                            ...
                            <div className="grid grid-cols-12 gap-4 mb-4">
                                ...
                                <button onClick={handleAddToCart} className="col-span-8 h-12 bg-black text-white font-medium hover:bg-gray-800 transition-colors rounded-4xl cursor-pointer">
                                    Add to Cart
                                </button>
                                ...
                                <div className="w-12 h-12 border border-gray-300 rounded-4xl flex items-center justify-center hover:bg-gray-100 transition-colors">
                                    {product && (
                                        <WishlistIcon product={product} size={20} />
                                    )}
                                </div>
                            </div>
