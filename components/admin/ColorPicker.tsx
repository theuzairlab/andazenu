  ...
  return (
    <div className="space-y-6">
      {showInstructions && (
        <div className="bg-blue-50 p-4 rounded-md border border-blue-200 mb-4">
          ...
          <ol className="list-decimal pl-4 text-sm text-blue-800 space-y-1">
            ...
            <li>Use the color picker to select the exact color that matches the shirt in the image</li>
      ...
      <div className="border-t pt-4">
        ...
        {!pendingImage ? (
          <div>
            <label htmlFor="new-color-image" className="block text-sm font-medium text-gray-700 mb-1">
