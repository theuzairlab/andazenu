...
export default function ProductsSlider({title, description, products, viewAllPageLink}: ProductsSliderProps) {
                ...
                >
                  <div className="mx-2 bg-gray-50 rounded-xl overflow-hidden relative">
                    ...
                    <div className="p-4 bg-white flex flex-col justify-center items-center">
                      <Link href={`/product/${product.id}`} className="font-bold text-md mb-1 text-center hover:text-gray-500">{product.title}</Link>
