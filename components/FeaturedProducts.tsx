...
export default function FeaturedProducts({title, description, products, viewAllPageLink}: featuredProductsProps) {
    ...
    <section className="py-16 bg-white w-full">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 text-black">
                ...
                >
                  <div className="mx-2 bg-gray-50 rounded-xl overflow-hidden relative">
                    ...
                    <div className="p-4 bg-white flex flex-col justify-center items-center">
                      <Link href={`/product/${product.id}`} className="font-bold text-md mb-1 text-center hover:text-gray-700">{product.title}</Link>
        ...
        <div className="text-center mt-10">
          <Link href={viewAllPageLink} className="inline-block border border-black text-black px-8 py-2.5 font-medium hover:bg-black hover:text-white transition-colors text-sm rounded">
            View All
          </Link>
        </div>
      </div>
